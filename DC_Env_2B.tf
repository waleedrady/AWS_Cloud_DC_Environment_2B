module "DC_Enviroment_2B" {

  source  = "WEEMR/DataCenter_Enviroment_2B/aws"
  version = "0.1.0"
  ...
  #            Terraform Registery Module = https://registry.terraform.io/modules/WEEMR/DataCenter_Enviroment_2B/aws/latest

  #                             Source Code = https://github.com/WEEMR/terraform-aws-DataCenter_Enviroment_2B
...
output "AWS_US_East_Hub_1_VPC_ID" {
  value = module.DC_Enviroment_2B.AWS_US_East_Hub_1_VPC_ID
}

output "AWS_US_East_Spoke_1_VPC_ID" {
  value = module.DC_Enviroment_2B.AWS_US_East_Spoke_1_VPC_ID
}
...
output "hub_1_WAN_1_IP" {
  value = module.DC_Enviroment_2B.hub_1_WAN_1_EIP
}

output "hub_1_WAN_2_IP" {
  value = module.DC_Enviroment_2B.hub_1_WAN_2_EIP
}

output "hub1_FGT_DNS_Name" {
  value = module.DC_Enviroment_2B.hub1_FGT_DNS_Name
}

output "hub1_Linux_DNS_Name" {
  value = module.DC_Enviroment_2B.hub1_Linux_DNS_Name
}

output "hub1_FMG_DNS_Name" {
  value = module.DC_Enviroment_2B.hub1_FMG_DNS_Name
}

output "hub1_Windows_DNS_Name" {
  value = module.DC_Enviroment_2B.hub1_Windows_DNS_Name
}
...
output "spoke_1_WAN_1_IP" {
  value = module.DC_Enviroment_2B.spoke_1_WAN_1_EIP
}

output "spoke_1_WAN_2_IP" {
  value = module.DC_Enviroment_2B.spoke_1_WAN_2_EIP
}

output "spoke1_FGT_DNS_Name" {
  value = module.DC_Enviroment_2B.spoke1_FGT_DNS_Name
}

output "spoke1_Linux_DNS_Name" {
  value = module.DC_Enviroment_2B.spoke1_Linux_DNS_Name
}

output "spoke1_Windows_DNS_Name" {
  value = module.DC_Enviroment_2B.spoke1_Windows_DNS_Name
}
